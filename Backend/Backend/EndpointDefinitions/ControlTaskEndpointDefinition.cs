...
public class ControlTaskEndpointDefinition : IEndpointDefinition
{
    ...
    {
        this.app = app;
        this.app.MapPut("api/controltasks", async (ControlTaskRequestBody body, StudyControlDbContext dbContext) => await AddNewItem(body, dbContext)).RequireCors("allowAny");
    ...
    private async Task<IResult> AddNewItem(ControlTaskRequestBody body, StudyControlDbContext dbContext)
    {
